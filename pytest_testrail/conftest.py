...
def pytest_addoption(parser):
    ...
    group.addoption(
        ...
        action='store_true',
        required=False,
        help='Test failed cases in testrun only')
    group.addoption(
        '--tr-retest-all',
        action='store_true',
        required=False,
        help='Test all test cases (include failed and passed cases) except those blocked in testrun')
    group.addoption(
        '--tr-milestone-id',
        action='store',
        default=None,
    ...
    if config.getoption('--testrail'):
        ...
        config.pluginmanager.register(
            PyTestRailPlugin(
                ...
                retest_failed=config.getoption('--tr-retest-failed'),
                retest_all=config.getoption('--tr-retest-all'),
